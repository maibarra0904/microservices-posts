...
const PostTarget: React.FC<PostTargetProps> = ({title}) => {
    return (
      ...
      <div className="p-5">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Aquí puedes agregar una breve descripción del post.</p>
